...
require (
	...
	go.opentelemetry.io/contrib/propagators/autoprop v0.0.0-20220619223623-e0e74d25f89f
...
replace (
	...
	google.golang.org/genproto => google.golang.org/genproto v0.0.0-20220324131243-acbaeb5b85eb
)
